...
public class FourImpl implements Four {
    ...
    private final String easyFight = "Easy fight";
    private final String goodFight = "A good fight";
    private final String intenseFight = "An intense fight";
    private final String defeated = "You've been defeated";

    private final List<String> ranks = Arrays.asList("Pushover", "Novice", "Fighter",
