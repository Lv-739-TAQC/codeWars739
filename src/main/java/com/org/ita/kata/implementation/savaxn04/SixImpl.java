...
public class SixImpl implements Six {
    ...
    public String nbaCup(String resultSheet, String toFind) {
        ...
        return builder.append("W=").append(wins).append(";D=").append(draws).append(";L=").append(loses).append(";Scored=").append(scored).append(";Conceded=").append(conceded).append(";Points=").append(points).toString();
    }
